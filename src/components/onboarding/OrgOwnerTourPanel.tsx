...
export function OrgOwnerTourPanel() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-[calc(5.5rem+var(--safe-area-bottom))] z-[60] flex justify-end px-3 desktop-shell:bottom-6 desktop-shell:px-6">
      <aside
