...
export function Topbar() {
  ...
  return (
    <>
    <header className="flex h-14 shrink-0 items-center justify-between gap-2 border-b border-stone-200 bg-white px-3 dark:border-stone-800 dark:bg-[#1c1917] sm:h-16 sm:px-6 [backdrop-filter:none] [-webkit-backdrop-filter:none]">
