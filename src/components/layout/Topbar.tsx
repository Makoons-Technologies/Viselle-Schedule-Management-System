...
export function Topbar() {
  ...
  return (
    <>
    <header className="app-shell-topbar flex h-14 shrink-0 items-center justify-between gap-2 border-b border-stone-200 px-safe-or-3 dark:border-stone-800 sm:h-16 sm:px-6">
