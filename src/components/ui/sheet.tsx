  ...
  'fixed z-50 gap-4 bg-white shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out dark:bg-stone-900',
  {
    variants: {
      side: {
        ...
        left:
          'top-0 bottom-0 left-0 h-auto min-h-0 w-full max-w-xs border-r border-stone-200 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left dark:border-stone-800',
      },
    },
