...
function TierCard({ tier }: { tier: PricingTier }) {
  return (
    <Card
      className={cn(
        'relative flex flex-col border-stone-200',
        tier.highlighted && 'border-brand-400 shadow-md ring-1 ring-brand-100',
      )}
    >
      {tier.highlighted && (
      ...
      <CardHeader className="pb-4">
        ...
        <div className="pt-2">
          <span className="text-3xl font-bold text-stone-900">${tier.priceMonthly}</span>
          <span className="text-sm text-stone-500">/month</span>
        </div>
        <p className="text-sm font-medium text-brand-700">{tier.staffLimit}</p>
      </CardHeader>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-stone-600">
            ...
            page — see{' '}
            <a href="#websites" className="font-medium text-brand-700 hover:underline">
