...
export function CalendarPage() {
  ...
  return (
    <div>
      ...
      />
      {selectMode && (
        <div className="fixed inset-x-0 bottom-16 z-50 border-t border-stone-200 bg-white/95 px-4 py-3 backdrop-blur-md dark:border-stone-800 dark:bg-stone-900/95 sm:px-6 desktop-shell:bottom-0">
